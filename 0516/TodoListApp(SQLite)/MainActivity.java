...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todoList = dbHelper.getAllTodos(); // 데이터베이스에서 로드

        todoAdapter = new TodoAdapter(todoList, dbHelper); // 어댑터 생성 시 dbHelper 전달
        ...
        buttonAdd.setOnClickListener(v -> {
            ...
            if (!todoText.isEmpty()) {
                ...
                long newId = dbHelper.insertTodo(newTodo);
                newTodo.setId(newId); // 데이터베이스에 삽입 후 ID 설정
    ...
    private void deleteTodoItem(int position) {
        TodoItem todoToDelete = todoList.get(position);
        dbHelper.deleteTodo(todoToDelete.getId());
