...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        colorButton1.setOnClickListener(v -> changeClothingColor(Color.RED));
        colorButton2.setOnClickListener(v -> changeClothingColor(Color.BLUE));
        colorButton3.setOnClickListener(v -> changeClothingColor(Color.GREEN));
        colorButton4.setOnClickListener(v -> changeClothingColor(Color.YELLOW));
    }
